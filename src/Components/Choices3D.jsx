...
const choices = [
    [],
    ["Un lienzo blanco lleno de potencial", "Una visión única del mundo", "Ilustrar algo único"],
    [],
    ["Como capturas la esencia", "Tus atmósferas cautivadores", "Cómo complementas la narrativa"],
    [],
    ["Tejer historias cautivadoras", "Tu perfección de la palabra", "Transmitir emoción en las palabras"],
]
