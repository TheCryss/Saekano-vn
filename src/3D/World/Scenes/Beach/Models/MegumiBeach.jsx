...
export const MegumiBeach = (props) => {
    const group = useRef();
    const { nodes, materials, animations } = useGLTF("/assets/models/megumi/MegumiBeach.glb");
...
useGLTF.preload("/assets/models/megumi/MegumiBeach.glb");
